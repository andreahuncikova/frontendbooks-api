        ...
        <form @submit.prevent="addProductHandler">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            <div class="flex flex-wrap gap-4 items-center px-4 py-2.5 rounded border col-span-full"
              style="border-color:#e7e5e4; background:#faf7f2;">
              <label class="flex items-center gap-2 text-sm" style="color:#78716c;">
                <input type="checkbox" v-model="newProduct.available" class="w-4 h-4" style="accent-color:#b45309;" />
                Available
              </label>
              <label class="flex items-center gap-2 text-sm" style="color:#78716c;">
                <input type="checkbox" v-model="newProduct.hidden" class="w-4 h-4" style="accent-color:#b45309;" />
                Hidden
              </label>
              <label class="flex items-center gap-2 text-sm" style="color:#78716c;">
                <input type="checkbox" v-model="newProduct.hasDiscount" class="w-4 h-4" style="accent-color:#b45309;" />
                Discount %:
              </label>
      ...
      <div v-for="product in products" :key="product._id"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          ...
          <div class="flex flex-wrap gap-4 items-center px-4 py-2 rounded border"
            style="border-color:#e7e5e4; background:#faf7f2;">
            <label class="flex items-center gap-2 text-sm" style="color:#78716c;">
              <input type="checkbox" v-model="product.available" class="w-4 h-4" style="accent-color:#b45309;" />
              Available
            </label>
            <label class="flex items-center gap-2 text-sm" style="color:#78716c;">
              <input type="checkbox" v-model="product.hidden" class="w-4 h-4" style="accent-color:#b45309;" />
              Hidden
            </label>
            <label class="flex items-center gap-2 text-sm" style="color:#78716c;">
              <input type="checkbox" v-model="product.hasDiscount" class="w-4 h-4" style="accent-color:#b45309;" />
              Discount %:
            </label>
          ...
          <div class="flex items-center gap-3">
            ...
            <span class="text-xs" style="color:#78716c;">Preview</span>
          </div>
        </div>
